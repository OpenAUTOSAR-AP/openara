...
class StateClient final
{
    ...
    *
    * @param[in] undefinedStateCallback callback to be invoked by StateClient library if a FunctionGroup changes its
    * state unexpectedly to an Undefined Function Group State, i.e. without previous request by SetState(). The affected
    * FunctionGroup and ExecutionError is provided as an argument to the callback in form of ExecutionError Event.
    */
    ...
    *
    * This function will return with error and will not return an ExecutionErrorEvent object, if the given Function
    * Group is in a defined Function Group state again.
    *
    * @param[in] functionGroup Function Group of interest.
    * @return ara::core::Result<ExecutionErrorEvent> The execution error which changed the given Function Group to an
    * Undefined Function Group State.
    */
